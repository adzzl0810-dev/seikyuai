        ...
        <div className="p-6">
          ...
          <div className="mt-6 pt-6 border-t border-slate-100 text-center">
            <button
              ...
              className="w-full bg-white border border-slate-200 text-slate-700 font-bold py-3 rounded-lg shadow-sm hover:bg-slate-50 transition-all flex justify-center items-center gap-2 mb-4"
            >
